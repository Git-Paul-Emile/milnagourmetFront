      ...
      <button
        ...
        className={cn(
          ...
          isNewYearTheme
            ...
            : 'bg-gradient-to-r from-primary via-primary-light to-primary bg-size-200 bg-pos-0 hover:bg-pos-100 text-primary-foreground hover:shadow-primary/25 before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-r before:from-primary/20 before:to-primary-light/20 before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300 hover:shadow-2xl hover:-translate-y-1'
        )}
      >
