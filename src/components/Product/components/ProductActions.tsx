  ...
  return (
    <button
      ...
      className={cn(
        ...
        product.available
          ? 'bg-button border border-button-border hover:bg-[#43A2F2] hover:text-white hover:border-[#43A2F2] text-button-foreground hover:scale-105 hover:-translate-y-0.5 active:scale-95'
